...
import { ArrowRight, Phone, Truck, PackageCheck, Warehouse, ShoppingBasket, Sparkles } from "lucide-react";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Nationaal en internationaal goederentransport, last-mile bezorging en distributie vanuit Sint-Pieters-Leeuw. Bel ons rechtstreeks voor uw transportvraag." },
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden" style={{ background: "var(--gradient-hero)" }}>
        ...
        <div className="relative mx-auto max-w-5xl px-4 sm:px-6 pt-16 pb-32 sm:pt-24 sm:pb-40 text-center">
          <div className="glass inline-flex items-center gap-2 rounded-full px-3 py-1.5 text-xs text-muted-foreground">
            <Sparkles className="h-3.5 w-3.5 text-primary-glow" />
            {t("hero.eyebrow")}
          </div>
          <h1 className="mx-auto mt-5 max-w-4xl text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.05]">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-24">
        <div className="max-w-2xl">
          <div className="text-xs font-bold uppercase tracking-widest text-primary-glow">{t("pillars.eyebrow")}</div>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 py-24">
        <div className="glass-strong rounded-3xl p-8 sm:p-14 text-center shadow-[var(--shadow-elegant)]" style={{ background: "linear-gradient(135deg, oklch(0.18 0.04 260 / 0.7), oklch(0.22 0.05 250 / 0.7))" }}>
          <h2 className="text-3xl sm:text-4xl font-black tracking-tight">{t("cta.title")}</h2>
