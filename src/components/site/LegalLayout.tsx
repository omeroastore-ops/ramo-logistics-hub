    ...
    <>
      <section className="relative overflow-hidden" style={{ background: "var(--gradient-hero)" }}>
        <div className="mx-auto max-w-4xl px-4 sm:px-6 py-16 sm:py-20">
          <div className="text-xs font-bold uppercase tracking-widest text-primary-glow">Legal</div>
          <h1 className="mt-3 text-4xl sm:text-5xl font-black tracking-tight">{title}</h1>
          {updated && <p className="mt-3 text-sm text-muted-foreground">Laatst bijgewerkt: {updated}</p>}
        </div>
      </section>
